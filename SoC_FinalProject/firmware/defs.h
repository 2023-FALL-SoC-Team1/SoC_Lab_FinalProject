...
#define TAP ((volatile int32_t*)0x30000040)
//matmul
#define MM_CTRL     (*(volatile uint32_t*)0x30000100)
#define arrA     (*(volatile int32_t*)0x30000180)
#define arrB     (*(volatile int32_t*)0x30000184)
#define arrR     (*(volatile int32_t*)0x3000018C)
